...
function EditPatient() {
  ...
  useEffect(() => {
    setTimeout(() => { // simulate a delay
      ...
      axios.post("https://alsalam-backend.onrender.com/api/getPatient", { id: patientID })
        .then((response) => {
  ...
  function handleResponse(event) {
    ...
    const patientID = localStorage.getItem('id');
    axios.put('https://alsalam-backend.onrender.com/api/updateResponse', { id: patientID, doctorResponse: response }).then(res => {
